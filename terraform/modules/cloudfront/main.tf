...
resource "aws_wafv2_web_acl_association" "medical_images_uk" {
  resource_arn = aws_cloudfront_distribution.medical_images.arn
  web_acl_arn  = aws_wafv2_web_acl.medical_images_uk.arn
}
