...
# OpenAI secret version (using variables only)
resource "aws_secretsmanager_secret_version" "openai_credentials" {
  ...
  secret_string = jsonencode({
    ...
    assistant_id = var.openai_assistant_id
...
# Azure Speech secret version (using variables only)
...
resource "aws_secretsmanager_secret_version" "google_vision_credentials" {
  ...
  secret_string = var.google_vision_credentials != null ? var.google_vision_credentials : jsonencode({
